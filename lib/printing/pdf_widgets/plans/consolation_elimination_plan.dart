...
class ConsolationEliminationPlan
  ...
  void _positionBrackets({
    ...
    for ((int, ConsolationTreeNode) childEntry
      ...
      models.TournamentMatch dashedLineOriginMatch =
          node.bracket.rounds[bracketOffset].last;
  ...
  ConsolationTreeNode _createConsolationTree(
    ...
    List<ConsolationTreeNode> consolationBrackets =
        bracket.consolations.map(_createConsolationTree).toList();
  ...
  Map<models.Slot, pw.Widget> _createConsolationPlaceholders(
    models.ConsolationBracket bracket,
  ) {
...
class ConsolationTreeNode {
  ...
  final models.ConsolationBracket bracket;
