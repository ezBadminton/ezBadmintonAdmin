...
class CourtList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<TabNavigationCubit, TabNavigationState>(
      listenWhen: (previous, current) =>
          ...
          current.tabChangeReason is TournamentMatch,
  ...
  Widget _buildCourtItem(
    ...
    Color occupationStatusColor = switch (matchOnCourt?.scheduledMatch.status) {
      ScheduleStatus.ready => Colors.orange,
      ScheduleStatus.inProgress => Colors.red,
      _ => Colors.green[400]!,
    };
