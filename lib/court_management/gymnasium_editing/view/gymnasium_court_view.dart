...
class _GymnasiumCourtViewState extends State<_GymnasiumCourtView>
  ...
  Widget build(BuildContext context) {
    ...
    var courtCubit = context.read<CourtCubit>();
      ...
      providers: [
        BlocProvider(
          ...
          create: (context) => CourtAddingCubit(
            courtRepository: context.read<ModelStore<Court>>(),
            gymnasiumRepository: context.read<ModelStore<Gymnasium>>(),
        ...
        BlocProvider(
          ...
          create: (context) => GymnasiumDeletionCubit(
            gymnasium: widget.gymnasium,
            courtStateGetter: () => courtCubit.state,
            gymnasiumRepository: context.read<ModelStore<Gymnasium>>(),
            courtRepository: context.read<ModelStore<Court>>(),
          ),
        ),
